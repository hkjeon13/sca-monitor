...
- 완료: shell/navigation, overview dashboard, service list, basic service registration, endpoint test action, endpoint one-shot polling worker, push credential issue/revoke, integration guide, impact list, impact server-side filters, impact pagination/sorting, impact detail, impact status action panel
