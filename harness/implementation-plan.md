...
- 부분 완료: impact filtering은 API와 Web Console에서 status/risk/service/team/environment/package/advisory/KEV/search와 pagination/sorting을 제공한다. bulk action은 미구현
- 미구현: role-aware UI/API 인가, accepted risk role-aware 승인 정책, 운영 scheduler 등록
