...
- `scripts/backfill_canonical_impact_keys.py` 기반 기존 impact/suppression key canonical backfill dry-run/apply job 추가
...
- advisory canonicalization row merge 및 backfill conflict impact merge
- impact matcher
- risk scoring
