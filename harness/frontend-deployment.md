...
- integration guide: MVP는 `POST /api/v1/services/{service_id}/status` service-scoped snapshot push, bearer push token, idempotency header, schema v1.0 필수 필드 예시를 표시
- impact 상태 변경
