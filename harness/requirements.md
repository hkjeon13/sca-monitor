...
| REQ-ALERT-003 | Daily Digest 채널 | PARTIAL | 중앙 digest와 `owner_team`별 digest outbox/preview scope는 구현됨. 실제 운영 channel을 중앙 단일 채널로 둘지, 팀별 channel mapping을 둘지 결정 필요 |
