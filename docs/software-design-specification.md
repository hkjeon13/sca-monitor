...
- Canonicalization Status Console: `GET /api/v1/operations/canonicalization`과 Web Console Overview는 canonical advisory row merge dry-run 후보와 impact key backfill dry-run 후보를 요약해 FR-027 drift를 운영자가 확인할 수 있게 한다
