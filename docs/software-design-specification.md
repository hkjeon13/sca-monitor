...
- Snapshot Demo Push: `POST /api/v1/snapshots` 기반 dependency snapshot push 검증. `SCA_MONITOR_MAX_SNAPSHOT_PAYLOAD_BYTES` 기본 10MB와 `SCA_MONITOR_MAX_SNAPSHOT_DEPENDENCIES` 기본 10000개 제한을 적용해 과대 payload와 dependency 폭증을 거절한다
